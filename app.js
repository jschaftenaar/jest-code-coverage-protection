...
const app = {
  run() {
    // to run a combination of e.g. threshold and new or hold and new you can simply run the application twice with different parameters.
    ...
    program
      ...
      .option('-t, --total <threshold>', 'The minimal threshold the branch should have', '.70')
      .option('-n, --new <threshold','The minimal threshold new code should have', '.90')
